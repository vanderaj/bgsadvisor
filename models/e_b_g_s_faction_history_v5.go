...
// EBGSFactionHistoryV5 e b g s faction history v5
//
// swagger:model EBGSFactionHistoryV5
type EBGSFactionHistoryV5 struct {
...
// Validate validates this e b g s faction history v5
func (m *EBGSFactionHistoryV5) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EBGSFactionHistoryV5) validateActiveStates(formats strfmt.Registry) error {
...
func (m *EBGSFactionHistoryV5) validateConflicts(formats strfmt.Registry) error {
...
func (m *EBGSFactionHistoryV5) validatePendingStates(formats strfmt.Registry) error {
...
func (m *EBGSFactionHistoryV5) validateRecoveringStates(formats strfmt.Registry) error {
...
func (m *EBGSFactionHistoryV5) validateSystems(formats strfmt.Registry) error {
...
// ContextValidate validate this e b g s faction history v5 based on the context it is used
func (m *EBGSFactionHistoryV5) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *EBGSFactionHistoryV5) contextValidateActiveStates(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EBGSFactionHistoryV5) contextValidateConflicts(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EBGSFactionHistoryV5) contextValidatePendingStates(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EBGSFactionHistoryV5) contextValidateRecoveringStates(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EBGSFactionHistoryV5) contextValidateSystems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EBGSFactionHistoryV5) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *EBGSFactionHistoryV5) UnmarshalBinary(b []byte) error {
	var res EBGSFactionHistoryV5
